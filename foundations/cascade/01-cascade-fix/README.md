...
This next exercise for CSS Foundations is going to give youok at a closer lo the cascade, in particular specificity and rule order. Both the HTML and CSS files are filled out for you, so instead of adding rules yourself, you will simply be editing what is provided.
